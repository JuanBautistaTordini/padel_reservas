...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($dayOfWeek) || empty($startTime) || empty($endTime) || $price === '') {
    ...
    // Insertar nuevo precio por turno
    ...
    if ($stmt->execute()) {
        header('Location: ../../../index.php?page=admin-settings&success=price_added');
        exit;
    } else {
